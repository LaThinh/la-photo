...
export default function FavoritePhotos() {
	...
	return (
		<div
			className="favorite-photo-page lg:pb-10 flex flex-col gap-5 lg:gap-10"
		...
		>
			<Suspense fallback={<Loading />}>
				<div className="bg-gray-100 relative flex-center w-[98%] m-auto min-h-72 rounded-3xl">
					...
					<div className="background-overlay absolute z-10 bg-gray-700/40 top-0 left-0 right-0 bottom-0"></div>
